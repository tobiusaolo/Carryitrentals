...
/** Viewing / inspection booking API (rental-units routes). */
export const inspectionAPI = {
  ...
  getMyBookings: () => api.get('/rental-units/inspections/my-bookings'),

  getPendingInspections: () => api.get('/rental-units/inspections/pending'),

  getUnitInspections: (unitId) => api.get(`/rental-units/${unitId}/inspections`),
};
